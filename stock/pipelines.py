...
class StockPreProcPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        item['open'] = getFloat(item.get('open'), 'NULL')
        item['high'] = getFloat(item.get('high'), 'NULL')
        item['low'] = getFloat(item.get('low'), 'NULL')
        item['close'] = getFloat(item.get('close'), 'NULL')
        item['pe'] = getFloat(item.get('pe'), 'NULL')
        item['volume'] = getFloat(item.get('volume'), 'NULL')
        item['last'] = getFloat(item.get('last'), 'NULL')
        item['turnover'] = getFloat(item.get('turnover'), 'NULL')
        item['turnover_rate'] = getFloat(item.get('turnover_rate'), 'NULL')
        item['volume_ratio'] = getFloat(item.get('volume_ratio'), 'NULL')
        item['limit_up'] = getFloat(item.get('limit_up'), 'NULL')
        item['limit_down'] = getFloat(item.get('limit_down'), 'NULL')
        item['preclose'] = getFloat(item.get('preclose'), 'NULL')
        item['flow_equity'] = getFloat(item.get('flow_equity'), 'NULL')
        item['total_equity'] = getFloat(item.get('total_equity'), 'NULL')
